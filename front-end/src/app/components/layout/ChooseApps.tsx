  ...
  return (
    <SectionComponent>
        ...
        <div className="text-center my-6">
          <Button asChild className ="mt-4 bg-gradient-to-r from-[#FF3399] to-[#3B82F6] transition-opacity duration-500 opacity-70 hover:opacity-100">
            <Link href="/applications">Installer</Link>
          </Button>
        </div>
    </SectionComponent>
  )
